...
test("GNOME Arc Reactor HUD is a state-driven optional extension", async () => {
  ...
  assert.match(extension, /voxtype-arc-orbit/)
  assert.match(extension, /voxtype-arc-inner/)
  ...
  assert.match(stylesheet, /width:\s*142px/)
  assert.match(stylesheet, /width:\s*106px/)
