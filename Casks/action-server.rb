cask "action-server" do
  ...
  on_macos do
    ...
    on_arm do
      ...
      url "https://github.com/joshyorko/actions/releases/download/actions-runtime-1.0.1/actions-runtime-1.0.1-macos-arm64"
  ...
  on_linux do
    ...
    url "https://github.com/joshyorko/actions/releases/download/actions-runtime-1.0.1/actions-runtime-1.0.1-linux64"
